export const blindferenceAttestorAbi = [
  {
    type: "function",
    name: "outputOf",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "modelKey", type: "bytes32", indexed: false },
    ],
    anonymous: false,
  },
] as const;

export const blindferenceUnderwriterAbi = [
  {
    type: "function",
